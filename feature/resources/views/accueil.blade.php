        ...
        <div id="right" class="content">
            ...
            <ol class="number">
                ...
                <li>Graphs and images
                    <ul class="disc">
                        <p>may be uploaded in JPG, PNG and GIF format only. When including a table, it is recommended to
                            save the table as an image and then upload it into the abstract.  Please note: word count is
                            affected when graphs/tables/images are added.</p>
                    </ul>
                </li>
            ...
            <p class="divider">&nbsp;</p>
            <ul class="disc">
                <li>Once the summaries have been received, they will be evaluated by members of the MEAVC Scientific
                ...
                <li>Once the summaries have been evaluated, the authors will be informed as to whether or not their
