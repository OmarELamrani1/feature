                                                        ...
                                                        <form action="{{ route('abstractsubmission.store') }}" method="POST"
                                                            ...
                                                            <div class="bs-stepper-content">
                                                                ...
                                                                <div id="TitleTopic-part" class="content" role="tabpanel"
                                                                    ...
                                                                    <span>Please enter the title of your abstract, select the topic.</span><br>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control" name="topic_id" id="topic_id">
                                                                            <option value="choose" disabled selected>Choose Topic</option>
                                                                    ...
                                                                    <button type="button" id="next-button-1"
                                                                        ...
                                                                        onclick="stepper.next()">Next <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
                                                                            <path fill-rule="evenodd" d="M4.646 11.354a.5.5 0 0 1 0-.708L7.293 8 4.646 5.354a.5.5 0 0 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0z"/>
                                                                            <path fill-rule="evenodd" d="M9 8a.5.5 0 0 0-.5-.5H3a.5.5 0 0 0 0 1h5.5A.5.5 0 0 0 9 8z"/>
                                                                          </svg></button>
                                                                </div>
...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addAuthor" data-bs-whatever="@getbootstrap">Add Author <i class="fas fa-user-plus"></i></button>

<div class="modal fade" id="addAuthor" tabindex="-1" aria-labelledby="addAuthorLabel" aria-hidden="true">

    <div class="relative w-full h-full max-w-md md:h-auto modal-dialog">
        <!-- Modal content -->
        <div class="modal-content relative bg-white rounded-lg shadow dark:bg-gray-700" style="width: 185% !important; padding:15px;">

            <div class="modal-header">
                <h3 class="modal-title fs-5" id="addAuthorLabel">Add new Author</h3>
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <div>
                    ...
                    <div class="mb-3" style="display: flex;">
                        <input type="search" id="last-name" name="lastname" class="form-control" id="keywords" placeholder="Search authors by Last Name">
                        <button id="search-button" type="button" class="btn btn-primary" data-search-url="{{ route('searchAuthors') }}" style="margin-left: 10px;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                            <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
                          </svg></button>
                    </div>

                    {{-- <div class="inline-flex mb-3">
                        <input class="mt-2 form-control" type="text" id="last-name" name="lastname" placeholder="Search authors by Last Name">
                        <button type="button"
                ...
                <form id="step2-form" class="space-y-6"
                    ...
                    <div class="inline-flex" style="display: flex;">
                        ...
                        <div class="mb-3" style="flex: 1;">
                            ...
                            <input type="text" name="departement" id="departement" placeholder="Departement" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="inline-flex" style="display: flex;">
                        <div class="mb-3" style="flex: 1; margin-right: 10px;">
                            ...
                            <input type="text" name="institution" id="institution" placeholder="Institution" class="form-control">
                        </div>
                    ...
                    <button id="submitAuthor" type="button" class="btn btn-primary">Add Author</button>
                </form>
            </div>
                                                                    ...
                                                                    <button type="button"
                                                                        class="btn btn-primary"
                                                                        onclick="stepper.previous()"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
                                                                            <path fill-rule="evenodd" d="M11.354 4.646a.5.5 0 0 1 0 .708L8.707 8l2.647 2.646a.5.5 0 1 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 0 1 .708 0z"/>
                                                                            <path fill-rule="evenodd" d="M5 8a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1H5.5A.5.5 0 0 1 5 8z"/>
                                                                          </svg> Previous</button>
                                                                ...
                                                                <div id="Keywords-part" class="content" role="tabpanel"
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="mb-3" style="display: flex;">
                                                                            ...
                                                                            <button id="addKeywordBtn" type="button" class="btn btn-primary" style="margin-left: 10px;">Add</button>
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <span style="color: red;" id="introduction-error"
                                                                                class="error"></span>
                                                                            <textarea name="introduction" id="introduction" class="form-control" style="width: 200px !important;"
